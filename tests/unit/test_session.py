...
The additive module-function surface in ``my_g4public_orm.core.session`` —
...
def _preserve_session_state():
    ...
    """
    from my_g4public_orm.core import session as session_module
...
def _sqlite_settings():
    """Return a SQLite ``DatabaseSettings`` (no MySQL server required)."""
...
class TestReExports:
    ...
    def test_readonly_session_error_is_db_common(self) -> None:
        from my_g4public_orm.core.session import ReadOnlySessionError

        assert ReadOnlySessionError is db_common.ReadOnlySessionError

    def test_session_error_is_db_common(self) -> None:
        from my_g4public_orm.core.session import SessionError
...
class TestNotInitialized:
    ...
    def test_get_engine_raises_before_init(self) -> None:
        from my_g4public_orm.core.session import SessionError, get_engine
    ...
    def test_get_settings_raises_before_init(self) -> None:
        from my_g4public_orm.core.session import SessionError, get_settings
...
class TestInitializeEngine:
    ...
    def test_get_settings_returns_initialized_settings(self) -> None:
        from my_g4public_orm.core.session import get_settings, initialize_engine
...
class TestReadWriteSession:
    ...
    def test_select_one(self) -> None:
        from my_g4public_orm.core.session import (
