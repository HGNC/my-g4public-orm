...
def test_repositories_package_reexports_repository() -> None:
    """Package import surface should expose ``Repository``."""
    from my_g4public_orm.repositories import Repository as package_repository

    assert package_repository is Repository
